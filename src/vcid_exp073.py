...
CFG["SUMMARY"] = f"{EXP_NAME}: model:efficientnetb6, grid img size 512, img size 512, not channel shuffle, bcewithlogits weight, CosineAnealing, lr=1e-3, loss weights 0.3, small grid"
