...
CFG["SUMMARY"] = "ex062: subtask-class. model:efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.4-0.4, mask-class=0.6:0.4, Cycliclr, lr=1e-3"
...
def criterion(preds_class, targets_class, preds_mask, targets_mask):
    return 0.4*BCE_Class(preds_class, targets_class) + 0.6*BCE_Mask(preds_mask, targets_mask)
