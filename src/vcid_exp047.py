...
CFG["SUMMARY"] = "ex047,same with 046. run again. model: efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.2"
...
def training_loop(CFG):
    ...
    for fold in CFG["folds"]:
        ...
        for slice_idx, surface_list in enumerate(CFG["SURFACE_LIST"]):
            LOGGER.info("surface_list: ", surface_list)
    ...
    for fold in CFG["folds"]:
        ...
        for slice_idx, surface_list in enumerate(CFG["SURFACE_LIST"]):
            ...
            for slide_pos in CFG["slide_pos_list"]:
                LOGGER.info("slide pos:", slide_pos)
                valid_dirs = CFG["VALID_DIR_LIST"][fold]
