...
CFG["SUMMARY"] = "ex050: subtask-class. model:efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.3-0.7"
...
BCE_Class = torch.nn.BCEWithLogitsLoss(pos_weight=torch.tensor([0.7]).cuda())
