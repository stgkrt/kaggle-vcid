...
CFG["SUMMARY"] = f"{EXP_NAME}: model:efficientnetb6, grid img size 128, img size 256, not channel shuffle, bcewithlogits weight, CosineAnealing, lr=1e-3, loss weights, small grid"
