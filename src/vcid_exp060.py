...
CFG["SUMMARY"] = "ex059: subtask-class. model:efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.3-0.3, mask-class=0.8:0.2, Cycliclr, lr=1e-4"
