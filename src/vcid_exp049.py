...
CFG["SUMMARY"] = "ex049: subtask-class. model:efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.3-0.5"
...
BCE_Class = torch.nn.BCEWithLogitsLoss(pos_weight=torch.tensor([0.5]).cuda())
