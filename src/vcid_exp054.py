...
CFG["SUMMARY"] = "ex054: subtask-class. model:efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.3-0.3, mask-class=0.4:0.6"
...
def criterion(preds_class, targets_class, preds_mask, targets_mask):
    return 0.6*BCE_Class(preds_class, targets_class) + 0.4*BCE_Mask(preds_mask, targets_mask)
