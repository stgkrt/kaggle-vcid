...
CFG["SUMMARY"] = "ex053: subtask-class. model:efficientnetb6, img size 512, not channel shuffle, bcewithlogits weight 0.2-0.2, mask-class=0.2:0.8"
...
def criterion(preds_class, targets_class, preds_mask, targets_mask):
    return 0.8*BCE_Class(preds_class, targets_class) + 0.2*BCE_Mask(preds_mask, targets_mask)
