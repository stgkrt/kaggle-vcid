...
CFG["SUMMARY"] = f"{EXP_NAME}: not train. model is exp089 blur inference, grid img size 256, img size 512"
        ...
        for slice_idx, surface_list in enumerate(CFG["SURFACE_LIST"]):
            ...
            for slide_pos in CFG["slide_pos_list"]:
                ...
                for tta in tta_list:
                    ...
                    # 全部のsurfaceでblurする
                    # valid_preds_img = cv2.GaussianBlur(valid_preds_img, (65, 65), 32)
